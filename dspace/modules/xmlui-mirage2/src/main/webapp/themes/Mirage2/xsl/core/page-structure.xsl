                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a href="{$context-path}/" class="navbar-brand">
                                <img src="{$theme-path}images/UP_Visayas_Logo.svg"/>
                        </a>
                        </span>
                        <span class="headerInfoName hidden-xs">University of the Philippines Visayas</span>
                        <span class="headerInfoShortName visible-xs">UP Visayas</span>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-7 col-sm-8">
                        <div class="hidden-print">
                            ...
                            <xsl:text>&#160;</xsl:text>
                            <a target="_blank" href="https://library.upv.edu.ph">
                                <xsl:text>UP Visayas Library</xsl:text>
                            </a>
                            <xsl:text> | </xsl:text>
                            <a target="_blank" href="https://www.upv.edu.ph">
                                    <xsl:text>University of the Philippines Visayas</xsl:text>
                            </a>
                        </div>
                    </div>
